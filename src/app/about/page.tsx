        ...
        <div>
          <Section title="Жоба туралы" eyebrow="Smart Green Book — Zhetysu">
            <p>
              ...
              өсімдіктерінің цифрлық базасы. Негізгі төрт модуль: интерактивті карта (PlantMap),
              әр түрдің QR-паспорты, өсімдік-индикаторлар арқылы аймақтарды салыстыру
              (BioIndicator) және Қызыл кітап пен эндемиктердің жеке базасы.
            </p>
            <p>
              Оларға далалық анықтағыш қосылды: базаны оқуға ғана емес, көрген өсімдікті анықтауға
              да пайдалануға болады. BioIndicator модулі де тек дайын аймақтарды көрсетіп қоймай,
              пайдаланушының өз учаскесін сол формула бойынша бағалайды.
            </p>
            <p>
          ...
          <Section title="Өз учаскесін бағалау">
            <p>
              Сол формула дайын аймақтарға ғана емес, кез келген түрлер жиынтығына қолданылады.
              «BioIndicator» бетіндегі «Өз учаскеңізді бағалау» бөлімінде пайдаланушы өзі
              кездестірген түрлерді белгілейді — индекс, орташа көрсеткіштер және мәтіндік
              қорытынды дәл сол әдіспен есептеледі.
            </p>
            <p>
              Кемінде үш түр белгіленбейінше баға берілмейді: іріктеме аз болса, орташа мәндер
              кездейсоқ шығады. Есептеу түгелдей браузерде жүреді, ешқандай дерек серверге
              жіберілмейді және сақталмайды.
            </p>
          </Section>

          <Section title="Анықтағыштың белгілері" eyebrow="Далалық анықтау">
            <p>
              Әр түрге бес далалық белгі жазылған: тіршілік формасы, ересек өсімдіктің биіктігі,
              гүлінің түсі, гүлдеу айлары және мекен түрі. Бұл мәндер сол түрдің паспортындағы
              морфология мен фенология сипаттамасынан алынған, сондықтан анықтағыш пен паспорт
              бір-біріне қайшы келмейді.
            </p>
            <p>
              Анықтағыш түрлерді қатаң сүзбейді, әр белгі бойынша сәйкестікті санайды: далада
              жартылай бұтаны бұтадан ажырату немесе биіктікті шамалау оңай емес. Барлық белгісі
              сәйкес келген түрлер жоғарыда, бір белгі бойынша ғана ерекшеленетіндері төменде,
              қай белгі сәйкес келмегені көрсетіліп тұрады. Екі және одан көп белгі бойынша
              ерекшеленетін түрлер тізімнен шығарылады.
            </p>
            <p>
              Желмен тозаңданатын түрлерде (астық тұқымдастар, алабұталар, теректер) гүл түсі
              «гүлі ұсақ, байқалмайды» деп белгіленген — оларды қалған белгілер бойынша анықтаған
              дұрыс.
            </p>
          </Section>

          <Section title="Офлайн режим">
            <p>
              Түрлер өсетін жерде ұялы байланыс жиі болмайды, ал QR-код тек сілтеме — оны ашу үшін
              бет жүктелуі керек. Сондықтан сайт браузердің кэшіне сақталады: «QR-кодтар» бетіндегі
              «Офлайн жүктеу» батырмасы барлық түрдің паспорттарын, суреттерін және кодтарын
              телефон жадына жүктейді.
            </p>
            <p>
              Жүктеу автоматты түрде емес, тек батырма арқылы басталады — бұл бірнеше мегабайт
              трафик, оны жұмсау туралы шешімді пайдаланушы өзі қабылдауы керек. Картаның
              подложкасы (OpenStreetMap плиткалары) кэшке алынбайды: ол сыртқы сервистің мыңдаған
              файлы.
            </p>
          </Section>
